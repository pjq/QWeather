...
public class HandleParseXML extends DefaultHandler {
    ...
    public void startDocument() throws SAXException {
        ...
        this.weatherData.setForecastInformationData(new ForecastInformationData());
    }
    ...
    @Override
    public void startElement(String namespaceUIR, String localName, String qName, Attributes atts)
            throws SAXException {
        if (localName.equals("forecast_information")) {
            ...
            this.weatherData.getForecastConditionsData().add(new ForecastConditionsData());
        } else {
            ...
            if (localName.equals("city")) {
                ...
                this.weatherData.getForecastInformationData().setPostalCode(data);
                ...
                this.weatherData.getForecastInformationData().setLongitude(data);

            } else if (localName.equals("forecast_date")) {
                this.weatherData.getForecastInformationData().setForecastDate(data);

            } else if (localName.equals("current_date_time")) {
                this.weatherData.getForecastInformationData().setCurrentDateTime(data);

            } else if (localName.equals("unit_system")) {
                this.weatherData.getForecastInformationData().setUnitSystem(data);

            } else if (localName.equals("condition")) {
                if (this.in_current_conditions) {
                    this.weatherData.getCurrentConditionsData().setCondition(data);
                } else if (this.in_forecast_conditions) {
                    this.weatherData.getLastForecastConditionsData().setCondition(data);
                }
                ...
                if (this.in_current_conditions) {
                    ...
                    this.weatherData.getLastForecastConditionsData().setIcon(data);
                }

            } else if (localName.equals("wind_condition")) {
                this.weatherData.getCurrentConditionsData().setWindCondition(data);

            } else if (localName.equals("day_of_week")) {
                this.weatherData.getLastForecastConditionsData().setDayOfWeek(data);
